package org.golde.enhancedvanilla.client.gui.controls;
...
public class GuiNewKeyBindingList extends GuiListExtended
{
    ...
    public GuiNewKeyBindingList(GuiNewControls controls, Minecraft mcIn)
    {
        ...
        for (KeyBinding keybinding : akeybinding)
        {
            ...
            this.listEntries[i++] = new GuiNewKeyBindingList.KeyEntry(keybinding);
        }
    }
    ...
    public class KeyEntry implements GuiListExtended.IGuiListEntry
    {
        ...
        public void drawEntry(int slotIndex, int x, int y, int listWidth, int slotHeight, int mouseX, int mouseY, boolean isSelected, float partialTicks)
        {
            ...
            this.btnReset.drawButton(GuiNewKeyBindingList.this.mc, mouseX, mouseY, partialTicks);
            ...
            this.btnChangeKeyBinding.drawButton(GuiNewKeyBindingList.this.mc, mouseX, mouseY, partialTicks);
        }
